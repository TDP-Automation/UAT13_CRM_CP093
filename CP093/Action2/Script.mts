...
RunAction "ValFinanciamiento", oneIteration
		End If
		'----------------------------------------------------------------------------------
        ...
        ElseIf ucase(Financiamiento) = "NO" Then
			...
			JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Cambio Simplificado (Para").JavaButton("Calcular").Click
			Dim b
			b = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Cambio Simplificado (Para").JavaStaticText("2628,00(st)").GetROProperty ("text")
			While (b = "0,00" or b = "0.00")
				 wait 1
				 b = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Cambio Simplificado (Para").JavaStaticText("2628,00(st)").GetROProperty ("text")
			Wend
...
'					If vardisp<>str_idDispositivo Then
						If  DataTable("Motivo", dtLocalSheet)="CAEQ_EQUIPO" Then
